...
export const OutlineEditor: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* 上下文栏 */}
      <div className="bg-ookoo-50 border-b border-ookoo-100 px-3 md:px-6 py-2 md:py-3 max-h-32 overflow-y-auto flex-shrink-0">
                ...
                <ul className="space-y-1.5 md:space-y-2">
                  {selectedPage.outline_content.points.map((point, idx) => (
                    <li key={idx} className="flex items-start text-sm md:text-base text-gray-700">
                      <span className="mr-2 text-ookoo-500 flex-shrink-0">•</span>
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
                ...
                <ul className="space-y-1">
                  {selectedPage.outline_content.points.map((point, idx) => (
                    <li key={idx} className="flex items-start text-xs text-gray-700">
                      <span className="mr-1.5 text-ookoo-500 flex-shrink-0">•</span>
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
