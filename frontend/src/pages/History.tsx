...
export const History: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ookoo-50 via-white to-gray-50">
      {/* 导航栏 */}
              ...
              <div className="flex items-center gap-3 pb-2 border-b border-gray-200">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 text-ookoo-600 border-gray-300 rounded focus:ring-ookoo-500"
                  />
