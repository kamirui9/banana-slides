      ...
      return (
        <div key={field.key}>
          ...
          <select
            ...
            className="w-full h-10 px-4 rounded-lg border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-ookoo-500 focus:border-transparent"
          >
            {field.options.map((option) => (
...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ookoo-50 to-yellow-50">
