  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50/30 to-pink-50/50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-ookoo-500/10 rounded-full blur-3xl animate-pulse"></div>
      ...
      <nav className="relative h-16 md:h-18 bg-white/40 backdrop-blur-2xl">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl md:text-2xl font-bold bg-gradient-to-r from-ookoo-600 via-ookoo-500 to-ookoo-400 bg-clip-text text-transparent">
              OoKoO Slides
            </span>
          </div>
      ...
      <main className="relative max-w-5xl mx-auto px-3 md:px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-10 md:mb-16 space-y-4 md:space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight">
            <span className="bg-gradient-to-r from-ookoo-600 via-ookoo-500 to-ookoo-400 bg-clip-text text-transparent" style={{
        ...
        <Card className="p-4 md:p-10 bg-white/90 backdrop-blur-xl shadow-2xl border-0 hover:shadow-3xl transition-all duration-300">
          ...
          <div className="relative">
            <p className="text-sm md:text-base mb-4 md:mb-6 leading-relaxed">
              <span className="inline-flex items-center gap-2 text-gray-600">
                <Lightbulb size={16} className="text-ookoo-600 flex-shrink-0" />
          ...
          <div className="relative mb-2 group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-ookoo-400 to-orange-400 rounded-lg opacity-0 group-hover:opacity-20 blur transition-opacity duration-300"></div>
            <Textarea
              ref={textareaRef}
              ...
              className="relative pr-20 md:pr-28 pb-12 md:pb-14 text-sm md:text-base border-2 border-gray-200 focus:border-ookoo-400 transition-colors duration-200" // 为右下角按钮留空间
            />
