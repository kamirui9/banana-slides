  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden min-w-0 min-h-0">
        ...
        {/* 右侧：大图预览 */}
        <main className="flex-1 flex flex-col bg-gradient-to-br from-ookoo-50 via-white to-gray-50 min-w-0 overflow-hidden">
                            ...
                            {imageVersions.map((version) => (
                              <button
                                ...
                                className={`w-full px-3 md:px-4 py-2 text-left hover:bg-gray-50 transition-colors flex items-center justify-between text-xs md:text-sm ${
                                  version.is_current ? 'bg-ookoo-50' : ''
                                }`}
                              >
                                <div className="flex items-center gap-2">
                                  ...
                                  {version.is_current && (
                                    <span className="text-xs text-ookoo-600 font-medium">
                                      (当前)
                                    </span>
                                  )}
                                </div>
            ...
            {imageUrl && (
              <>
                ...
                <button
                  ...
                  className="absolute top-2 left-2 z-10 px-2 py-1 rounded bg-white/80 text-[10px] text-gray-700 hover:bg-ookoo-50 shadow-sm flex items-center gap-1"
                >
                  <Sparkles size={12} />
                ...
                {selectionRect && (
                  <div
                    className="absolute border-2 border-ookoo-500 bg-ookoo-400/10 pointer-events-none"
                    style={{
          ...
          <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 space-y-4">
            ...
            {currentProject?.template_image_path && (
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-4 h-4 text-ookoo-600 rounded focus:ring-ookoo-500"
                />
                    ...
                    {descImageUrls.map((url, idx) => (
                      <div key={idx} className="relative group">
                        ...
                        {selectedContextImages.descImageUrls.includes(url) && (
                          <div className="absolute inset-0 bg-ookoo-500/20 border-2 border-ookoo-500 rounded flex items-center justify-center">
                            <div className="w-6 h-6 bg-ookoo-500 rounded-full flex items-center justify-center">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <label className="w-20 h-20 border-2 border-dashed border-gray-300 rounded flex flex-col items-center justify-center cursor-pointer hover:border-ookoo-500 transition-colors">
